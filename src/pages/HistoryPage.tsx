...
const HistoryPage = () => {
  ...
  }, [checkedItems]); // Dependencies of useCallback
              ...
              >
                <Image
                  ...
                  style={{
                    borderRadius: '8px',
                    ...(item.isFallback && {
                      border: '1px solid #ccc', // Example of additional styles for fallback
                    }),
                  }}
                  preview={false}
                  ...
                  onError={() => handleImageError(index)} // Set fallback state for each item
                />
                <List.Item.Meta
                  title={
                    <div
                      style={{
                        ...
                        fontSize: '18px',
                        gap: '20px',
                        marginLeft: item.isFallback ? 50 : 0,
                      }}
                    >
